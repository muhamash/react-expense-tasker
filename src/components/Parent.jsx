...
export default function Parent() {
    const [expenses, setExpenses] = useState([
        { id: 1, title: "Education", date: "5 jan 2024", amount: 1000 },
        { id: 2, title: "Bill", date: "6 jan 2024", amount: 1000 },
        { id: 3, title: "Transport", date: "6 jan 2024", amount: 1000 }
    ]);
    ...
    const handleEdit = ( data, type ) =>
    {
        if ( type === "income" )
        {
            setEditData( income.filter( item => data.id === item.id ) );
        } else if ( type === 'expense' )
        {
            setEditData( expenses.filter( item => data.id === item.id ) );
        }
